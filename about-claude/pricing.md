...
When using Claude Sonnet 4 or Sonnet 4.5 with the [1M token context window enabled](https://platform.claude.com/docs/en/build-with-claude/context-windows#1m-token-context-window), requests that exceed 200K input tokens are automatically charged at premium long context rates:
...
For current per-model prices, refer to our [model pricing](https://platform.claude.com/docs/en/about-claude/pricing#model-pricing) section above.
...
Volume discounts may be available for high-volume users. These are negotiated on a case-by-case basis.
  ...
  * Enterprise customers can [contact sales](https://platform.claude.com/cdn-cgi/l/email-protection#8af9ebe6eff9caebe4fee2f8e5fae3e9a4e9e5e7) for custom pricing
...
Contact our sales team at [[email protected]](https://platform.claude.com/cdn-cgi/l/email-protection#a9dac8c5ccdae9c8c7ddc1dbc6d9c0ca87cac6c4) or through the [Claude Console](https://platform.claude.com/settings/limits) to discuss enterprise pricing options.
## 
Billing and payment
...
New users receive a small amount of free credits to test the API. [Contact sales](https://platform.claude.com/cdn-cgi/l/email-protection#4635272a2335062728322e3429362f256825292b) for information about extended trials for enterprise evaluation.
...
For additional questions about pricing, contact [[email protected]](https://platform.claude.com/cdn-cgi/l/email-protection#04777174746b767044656a706c766b746d672a676b69).
...
Contact our sales team at sales@anthropic.com or through the [Claude Console](https://platform.claude.com/settings/limits) to discuss enterprise pricing options.
## 
Billing and payment
  * Billing is calculated monthly based on actual usage
  * Payments are processed in USD
