...
**Pricing** 2 | $3 / input MTok$15 / output MTok | $1 / input MTok$5 / output MTok | $5 / input MTok$25 / output MTok  
...
**Context window** |  200K tokens / 1M tokens (beta)3 | 200K tokens | 200K tokens  
...
_2 - See our[pricing page](https://platform.claude.com/docs/en/about-claude/pricing) for complete pricing information including batch API discounts, prompt caching rates, extended thinking costs, and vision processing fees._
_3 - Claude Sonnet 4.5 supports a[1M token context window](https://platform.claude.com/docs/en/build-with-claude/context-windows#1m-token-context-window) when using the `context-1m-2025-08-07` beta header. [Long context pricing](https://platform.claude.com/docs/en/about-claude/pricing#long-context-pricing) applies to requests exceeding 200K tokens._
