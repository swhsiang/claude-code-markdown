...
```
  ...
  "data": [
      ...
      "actor": {
        "type": "user_actor",
        "email_address": "[email protected][](https://platform.claude.com/cdn-cgi/l/email-protection)"
      },
...
The Claude Code Analytics API helps you understand and optimize your team's development workflow. Learn more about related features:
  ...
  * [Usage and Cost API](https://platform.claude.com/docs/en/build-with-claude/usage-cost-api) - Track API usage across all Anthropic services
