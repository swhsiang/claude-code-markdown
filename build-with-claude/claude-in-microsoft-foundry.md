...
## 
Install an SDK
Anthropic's [client SDKs](https://platform.claude.com/docs/en/api/client-sdks) support Foundry through platform-specific packages.
Python
Python
TypeScript
TypeScript
...
Additional resources
  ...
  * **Authentication guide** : See the [authentication section](https://platform.claude.com/docs/en/build-with-claude/claude-in-microsoft-foundry#authentication) above
