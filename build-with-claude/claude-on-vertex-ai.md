...
Vertex is also supported by Anthropic's official [client SDKs](https://platform.claude.com/docs/en/api/client-sdks). This guide will walk you through the process of making a request to Claude on Vertex AI in either Python or TypeScript.
...
See our [client SDKs](https://platform.claude.com/docs/en/api/client-sdks) and the official [Vertex AI docs](https://cloud.google.com/vertex-ai/docs) for more details.
## 
Activity logging
...
## 
Feature support
You can find all the features currently supported on Vertex [here](https://platform.claude.com/docs/en/api/overview).
## 
