...
---|---|---  
Specialized capabilities defined in Markdown | `.claude/skills/SKILL.md`  
...
Project context and instructions |  `CLAUDE.md` or `.claude/CLAUDE.md`  
Extend with custom commands, agents, and MCP servers | Programmatic via `plugins` option  
## 
Get started
  1. 1
Install Claude Code
