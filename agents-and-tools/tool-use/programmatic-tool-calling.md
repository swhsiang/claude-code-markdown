...
To use this feature, add the `"advanced-tool-use-2025-11-20"` [beta header](https://platform.claude.com/docs/en/api/beta-headers) to your API requests.
...
## 
Related features
[ Code Execution Tool Learn about the underlying code execution capability that powers programmatic tool calling. ](https://platform.claude.com/docs/en/agents-and-tools/tool-use/code-execution-tool)[ Tool Use Overview Understand the fundamentals of tool use with Claude. ](https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview)[ Implement Tool Use Step-by-step guide for implementing tools. ](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use)
