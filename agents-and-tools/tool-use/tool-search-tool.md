...
The tool search tool is currently in public beta. Include the appropriate [beta header](https://platform.claude.com/docs/en/api/beta-headers) for your provider:
Provider | Beta header | Supported models  
---|---|---  
Claude APIMicrosoft Foundry | `advanced-tool-use-2025-11-20` | Claude Opus 4.5Claude Sonnet 4.5  
Google Cloud's Vertex AI | `tool-search-tool-2025-10-19` | Claude Opus 4.5Claude Sonnet 4.5  
Amazon Bedrock | `tool-search-tool-2025-10-19` | Claude Opus 4.5Claude Sonnet 4.5  
...
## 
Error handling
The tool search tool is not compatible with [tool use examples](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#providing-tool-use-examples). If you need to provide examples of tool usage, use standard tool calling without tool search.
### 
